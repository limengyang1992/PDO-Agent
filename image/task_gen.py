...
# 任务配置
# dataset_32：[CIFAR10, MNIST, Qmnist, KMNIST, Fashion MNIST, SVHN, STL10, CIFAR100, ]
# dataset_224：[FER2013,Clothing1M,EuroSAT, FGVCAircraft, OxfordIIIT Pet, Caltech101, Flowers102, Stanford Cars, Caltech256, SUN397, Places-LT, ImageNet-LT]
# class_sample: 
#     rate: 0.1~0.9
#     class_min:2
#     sample_min:2000
...
#     uuid：任务唯一标识
#     dataset：
#         reslution：[dataset_32,dataset_224]
#         regenerate：[class_sample, sample_sample, noise_generate, long_tail_generate]

#     loss fuction： [CE, LS, BS, Focal, LA]
#     model： [VGG, ResNet, Swin, Vit, Mobilenet]
#     hyperparameter：
#         Epoch
#             pretrain:[3~20]
#             other:[3~20]
...
#         LR [0.000,0.001,0.01,0.1]
#         LR decay [MultiStep, Cosine, Warm-up]
#         optimize [SGD, Adam, AdamW]
...
if __name__ == "__main__":
    generate_config(20,"./dataset/tasks/")
